...
const fakeData = [
  ...
  },
  {
    ...
    description:
      "Eco-friendly water bottle with a 1-liter capacity, keeps drinks hot or cold.",
    price: 19.99,
  ...
  },
  {
    ...
    description:
      "55-inch smart TV with 4K resolution, HDR support, and streaming apps.",
    price: 499.99,
  ...
  },
  {
    ...
    description:
      "Soft and breathable t-shirt made from 100% organic cotton. Available in multiple colors.",
    price: 29.99,
  ...
  },
  {
    ...
    description:
      "Adjustable height desk with a motorized lift system, perfect for home offices.",
    price: 299.99,
  ...
  },
  {
    ...
    description:
      "Voice-controlled speaker with smart assistant integration for home automation.",
    price: 129.99,
  ...
  },
  {
    name: "Yoga Mat",
    description:
      "Non-slip yoga mat with extra thickness for comfort during exercises.",
    price: 39.99,
  ...
  },
  {
    ...
    description:
      "Compact earbuds with active noise cancelation and a charging case.",
    price: 59.99,
    categories: ["Electronics", "Audio"],
    stock: 75,
  ...
  },
  {
    ...
    description:
      "Handmade ceramic mug with a unique design, perfect for coffee or tea.",
    price: 14.99,
  ...
  },
  {
    name: "LED Desk Lamp",
    description:
      "Adjustable LED lamp with touch control and multiple brightness settings.",
    price: 24.99,
  ...
  },
  {
    ...
    description:
      "Smartwatch with fitness tracking, notifications, and Bluetooth connectivity.",
    price: 199.99,
  ...
  },
  {
    ...
    description:
      "Complete grooming kit for pets, including brushes, clippers, and scissors.",
    price: 49.99,
    categories: ["Pet Supplies", "Grooming"],
    stock: 60,
    image: "https://example.com/images/grooming-kit.jpg",
  },
  {
    name: "Outdoor Camping Tent",
    description:
      "Spacious 4-person tent with waterproof and UV-resistant features.",
    price: 89.99,
